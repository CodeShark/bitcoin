...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = Consensus::SoftForks::UseRule(Consensus::SoftForks::BIP30, *pindex, chainparams.GetConsensus());
    ...
    bool fStrictPayToScriptHash = Consensus::SoftForks::UseRule(Consensus::SoftForks::BIP16, *pindex, chainparams.GetConsensus());

    unsigned int flags = fStrictPayToScriptHash ? SCRIPT_VERIFY_P2SH : SCRIPT_VERIFY_NONE;

    if (Consensus::SoftForks::UseRule(Consensus::SoftForks::BIP66, *pindex, chainparams.GetConsensus())) {
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    if (!Consensus::SoftForks::IsValidVersion(block, consensusParams, pindexPrev))
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    if (Consensus::SoftForks::UseRule(Consensus::SoftForks::BIP34, block, consensusParams, pindexPrev))
    {
